...
public class AdminController {
    ...
    public ResponseEntity<ApiResponse<Object>> deleteTeacher(@PathVariable("id") Long id, @RequestBody DeleteTrDto dto){
        try{
    ...
    public ResponseEntity<ApiResponse<Object>> deleteStudent(@PathVariable("id") Long id, @RequestBody DeleteStDto dto){
        try{
